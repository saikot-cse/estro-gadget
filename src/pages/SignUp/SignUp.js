    ...
    <div>
      ...
      <div className="bg-base-100 mt-16">
        <div className="flex justify-center h-screen">
          <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div className="flex-1">
              <div className="text-center">
                ...
                <p className="mt-3">Sign Up to create your account</p>
              </div>
              ...
              <div className="mt-8">
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mt-6">
                    <div className="flex justify-between mb-2">
                      ...
                      <NavLink to="#" className="text-sm text-primary focus:text-info hover:text-info hover:underline">
                        Forgot password?
                      </NavLink>
                    </div>
                ...
                <p className="mt-6 text-sm text-center ">
                  ...
                  <button onClick={() => signInWithGoogle()} className="flex items-center mx-auto justify-center mt-4 transition-colors duration-200 transform  rounded-lghover:bg-gray-600 dark:hover:bg-gray-600">
                    <div className="px-4 py-2  flex justify-center items-center border border-neutral">
                      ...
                      <span className="px-4 py-3 font-bold text-center">Continue with Google</span>
                    </div>
                  </button>
                </p>
              </div>
          ...
          <div className="hidden bg-cover lg:block lg:w-2/3 bg-signup">
