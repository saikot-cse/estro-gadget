    ...
    <div className="hero lg:h-[80vh] bg-secondary text-white">
      <div className="hero-content flex-col lg:flex-row">
        <div data-aos="fade-right">
          ...
          <p data-aos="fade-right" data-aos-delay="400" data-aos-duration="900" class="text-5xl font-bold" className="py-6 max-w-5xl">
          ...
          <button data-aos="zoom-in" data-aos-delay="1300" class="btn btn-primary" className="btn btn-primary">
            Get Started
          </button>
        </div>
