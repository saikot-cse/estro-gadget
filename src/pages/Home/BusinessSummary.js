    ...
    <div className="stats stats-vertical lg:stats-horizontal w-full my-16">
      <div className="stat text-center">
        <div className="stat-title">
          <FaUserAlt className="text-6xl text-accent block mx-auto mb-1" />
        </div>
      ...
      <div className="stat text-center">
        <div className="stat-title">
          <FaMoneyCheckAlt className="text-6xl text-accent block mx-auto mb-1" />
        </div>
        <div className="stat-value mb-1">4200M+</div>
        <div className="stat-desc text-lg">Annual Revenue</div>
      </div>

      <div className="stat text-center">
        <div className="stat-title">
          <ImHappy2 className="text-6xl text-accent block mx-auto mb-1" />
        </div>
      ...
      <div className="stat text-center">
        <div className="stat-title">
          <MdRateReview className="text-6xl text-accent block mx-auto mb-1" />
        </div>
