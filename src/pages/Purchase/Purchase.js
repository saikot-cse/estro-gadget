            ...
            <div className="hero-content flex-col  lg:flex-row-reverse">
                <div className="card max-w-lg bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p> <span className="text-xl font-bold">Available Quantity:</span> {productDetail.availableQuantity} </p>
                        <p> <span className="text-xl font-bold">Minimum Order Quantity:</span> {productDetail.minOrderQuantity} </p>
                        <p> <span className="text-xl font-bold">Price:$</span> {productDetail.price} </p>
                    </div>
                </div>
